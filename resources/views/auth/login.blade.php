                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <a href="{{ url('index') }}" class="mb-5 d-block auth-logo">
                            <img src="{{ URL::asset('/assets/images/logo-dark.png') }}" alt="" height="150"
                                class="logo logo-dark">
                            <img src="{{ URL::asset('/assets/images/logo-light.png') }}" alt="" height="150"
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="mt-5 text-center">
                        <p>© <script>
                            ...
                            </script> OHXRay. Crafted with <i class="mdi mdi-heart text-danger"></i> by CCS</p>
                    </div>
