...
<div class="row" >
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"> أملأ الاستبيان</h4>
                ...
                <div id="basic-example" style="background: linear-gradient(to bottom, white, rgba(75, 172, 75, 0.329));">
                    ...
                    @if($survey->type==0)
                        @if ($key==0)<h8>التوجه</h8>
                        @elseif ($key==1) <h8>المرونة</h8>
                        @elseif ($key==2) <h8>العلاقات الخارجية</h8>
                        @elseif ($key==3) <h8>الاستدامة</h8>
                        @elseif ($key==4) <h8>المسؤولية</h8>
                        @elseif ($key==5) <h8>القيادة</h8>
                        @elseif ($key==6) <h8>بيئة العمل</h8>
                        @elseif ($key==7) <h8>التحفيز</h8>
                        @elseif ($key==8) <h8>قيم المنظمة </h8>
                        @elseif ($key==9) <h8>الارتباط الوظيفي</h8>
                        @elseif ($key==10) <h8>الارتباط الوظيفي</h8>
                        @elseif ($key==11) <h8>المقترحات</h8>
                        @else <h8></h8>@endif
                    @else  
                      <h8></h8>
                    @endif
                      ...
                      <section>
                            ...
                            <div class="row">
                              @foreach($row as $key_q=>$question)
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mb-3">
                                                    <label for="basicpill-firstname-input">{{($key_q+1)}}- {{$question->question_ar}}</label>
                                                    @if($question->type==1)
