        ...
        <div class="indicators-by-gender" style="position: relative; top: 7600px;">
            ...
            <table>
                ...
                <tr style="text-align: center;">
                    ...
                    <td class="@if(number_format($focus_result_employee[0]['dimensional_results'][3]['value'],0) <= 25) bottom-quartile @elseif(number_format($focus_result_employee[0]['dimensional_results'][3]['value'],0) <= 50) third-quartile @elseif(number_format($focus_result_middle[0]['dimensional_results'][3]['value'],0) <= 80) second-quartile @else top-quartile @endif">{{ number_format($focus_result_middle[0]['dimensional_results'][3]['value'],0); }}</td>
                </tr>
            </table>        
            ...
            <table>
                ...
                <tr style="text-align: center;">
                    ...
                    <td>
                        ...
                        <div class="value-3 @if(number_format($focus_result_top[1]['dimensional_results'][0]['dimensional_results'][2]['value'],0) <= 25) bottom-quartile @elseif(number_format($focus_result_top[1]['dimensional_results'][0]['dimensional_results'][2]['value'],0) <= 50) third-quartile @elseif(number_format($focus_result_top[1]['dimensional_results'][0]['dimensional_results'][2]['value'],0) <= 80) second-quartile @else top-quartile @endif">{{number_format($focus_result_male[1]['dimensional_results'][1]['dimensional_results'][2]['value'],0);}}</div>
                    </td>
                    <td>
