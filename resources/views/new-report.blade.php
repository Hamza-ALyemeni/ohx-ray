...
<body data-layout="horizontal" data-topbar="colored">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h2>Reports @if(@$company) of Company {{$company->name}}@endif
                        <a href="@if(@$company){{url('company/'.$survey_company->id.'/exportReport')}}@else{{url('exportReport')}}@endif" class="btn btn-primary btn-lg waves-effect waves-light " style="float: right;margin: 15px;">Download</a>
                    </h2>
 <!-- Start of Custom -->
 <article class="custom">
        ...
        <div class="results">
            <div class="main">
                ...
                <h1 class="custom-title">
                    <i class="fa fa-sitemap"></i> Organiztion Results
            ...
            <div class="division">
                <h2 class="custom-title">
                    {{$focus['key']}}
                    <span class="percent">{{round($focus['value'])}}%</span>
                </h2>
                <div class="box-container">
                    <!-- Start of Direction -->
                    ...
                    <section class="box">
                        <h3 class="custom-title">
                            {{$dimensional['key']}}
                            <span class="percent">{{round($dimensional['value'])}}%</span>
                        </h3>
                        <div class="wrapper">
                            <!-- Start of Vision -->
                            ...
                            <div class="inner-box">
                                <h4 class="custom-title">
                                    {{$val['key']}}
                                    <span class="percent">{{round($val['value'])}}%</span>
                                </h4>
                                <ul class="question">
                                    <li>
                                        Q{{$x+1}}
                                        <span class="percent">{{round($val['questions']['q1'])}}%</span>
                                    </li>
                                    <li>
                                        Q{{$x+2}}
                                        <span class="percent">{{round(round($val['questions']['q2']))}}%</span>
                                    </li>
                                </ul>
                            </div>
                            @php($x +=2)
                        ...
                        <div class="wrapper">
                            ...
                            <div class="inner-box">
                                ...
                                <ul class="question">
                                    ...
                                    <li>
                                        Q{{$x+2}}
                                        <span class="percent">{{round($val['questions']['q2'])}}%</span>
                                    </li>
                                </ul>
                            </div>
                            @php($x +=2)
