           ...
           <!-- <div class="dropdown d-none d-lg-inline-block ms-1">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ URL::asset('assets/images/users/UserProfile.png')}}"
                        alt="Header Avatar">
                ...
                <div class="collapse navbar-collapse" id="topnav-menu-content">
                    <ul class="navbar-nav">
                        ...
                        <a class="nav-link" href="{{url('company')}}">
                                <i class="uil-building me-2"></i>@lang('Organizations')
                            </a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" href="{{url('survey')}}">
                                <i class="uil-copy me-2"></i>@lang('Surveys')
                            </a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" href="{{url('comparison/1')}}">
                                <i class="uil-layers me-2"></i>@lang('Comparisons')
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{url('demographic')}}">
                                    <i class="uil-layers me-2"></i>@lang('Demographics')
                                </a>
                            </li>

                        <li class="nav-item">
                        <a class="nav-link" href="{{url('notification')}}">
                                <i class="uil-bell me-2"></i>@lang('Notifications')
                            </a>
                        </li>
                        <li class="nav-item">
                        <a class="nav-link" href="{{url('faq/create')}}">
                                <i class="uil-window-section me-2"></i>@lang('FAQs')
                            </a>
                        </li>
